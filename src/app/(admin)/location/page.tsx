  ...
  return (
    <>
      ...
      <main className="shrink-0 items-center gap-2 px-4">
        <div className="mt-4 mb-8 w-full overflow-hidden rounded-xl border">
            ...
            <TableBody>
              {groupedLocations.map(({ location, indentation }) => (
                <TableRow key={location.id}>
                  <TableCell
                    style={{ paddingLeft: `${8 + indentation * 16}px` }}
                  >
                  ...
                  <TableCell className="text-right">{location.id}</TableCell>
                </TableRow>
              ))}
            </TableBody>
          </Table>
